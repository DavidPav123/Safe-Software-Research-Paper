...
for i in range(3):
    subprocess.call(f"valgrind --tool=massif --massif-out-file=\"/workspaces/Rusty-Kernels-Code/reverse-complement/C/Results/massif{i}.txt\" /workspaces/Rusty-Kernels-Code/reverse-complement/C/revcompC < /workspaces/Rusty-Kernels-Code/reverse-complement/input.txt > /dev/null", shell=True, executable="/bin/bash", stdout=subprocess.PIPE)
