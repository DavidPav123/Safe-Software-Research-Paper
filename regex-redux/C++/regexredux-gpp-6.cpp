...
inline PCRE2_UCHAR8* pcre2_buffer_cast(std::string& str) {
    return reinterpret_cast<PCRE2_UCHAR8*>(const_cast<char*>(str.data()));
}

inline const PCRE2_UCHAR8* pcre2_buffer_cast(const std::string& str) {
    return reinterpret_cast<const PCRE2_UCHAR8*>(str.data());
}
